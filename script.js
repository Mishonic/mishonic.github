...
stpbl1.onmouseover = function() {
    stpbrdr1.style.borderBottom = "3px solid #fff"
}
stpbl1.onmouseout = function() {
    stpbrdr1.style.borderBottom = "3px solid #000"
}

stpbl2.onmouseover = function() {
    stpbrdr2.style.borderBottom = "3px solid #fff"
}
stpbl2.onmouseout = function() {
    stpbrdr2.style.borderBottom = "3px solid #000"
}

stpbl3.onmouseover = function() {
    stpbrdr3.style.borderBottom = "3px solid #fff"
}
stpbl3.onmouseout = function() {
    stpbrdr3.style.borderBottom = "3px solid #000"
}